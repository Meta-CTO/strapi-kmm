    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            ...
            try {
                ...
                val flatted = JsonFlatter.flat<AppConfiguration>(json)
                println(flatted)
                val converted = flatted.convert<AppConfiguration>()

                val firstEducationLevel = converted.educationLevels?.firstOrNull()
                val lastEducationLevel = converted.educationLevels?.lastOrNull()
