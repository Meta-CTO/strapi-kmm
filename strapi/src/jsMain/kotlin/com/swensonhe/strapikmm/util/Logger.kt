...
/**
 * A Web-specific logger used to log messages with optional class name prefix.
 *
...
actual class Logger actual constructor(
    ...
    actual fun log(msg: String) {
        ...
        if (className.isEmpty()) {
            // If there is no class name, just log the message
            console.log(msg)
        } else {
            // If there is a class name, log the message with the class name prefix
